...
function workerMain() {
    ...
    function startRuntimeInitialization(first) {
        ...
        app = createApp({
            ...
            onRuntimeInitialized: first ? onFirstRuntimeInitialization : onRuntimeInitialized
        });
    }
    ...
    function onFirstRuntimeInitialization() {
        ...
        // The first time we want to run hermes with a dummy input, to compile all asm.js.
